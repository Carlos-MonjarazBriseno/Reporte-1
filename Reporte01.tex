...
Aparte del ejemplo se deben de saber los diferentes modos de simulación del software para saber las herramientas con las que 
se pueden trabajar.

\begin{itemize}
    \item flujo de potencia instantaneo (snapshot)
